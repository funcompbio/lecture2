...
.pull-left[
* Women contributed software and calculations for the
[Apollo spaceflight missions](https://en.wikipedia.org/wiki/Apollo_program) that
  allowed NASA to land the first humans on the Moon in 1969.  
  &nbsp;&nbsp;
![:scale 75%](img/MargaretHamilton.jpg)
]
.pull-right[
![:scale 60%](img/JoAnnHMorgan.jpg)
![:scale 60%](img/MargaretHamilton2.jpg)
![:scale 60%](img/MaryJackson.jpg)
]

.footer[JoAnn Morgan (top-right) chief computer services at NASA. Margaret
  Hamilton (bottom & right) lead computer programmer<br>for moon landings,
  Mary Jackson (bottom-right) orbital calculations; see the film
  [*Hidden Figures*, 2016](https://en.wikipedia.org/wiki/Hidden_Figures).]
---
...
* The [_shell_](https://en.wikipedia.org/wiki/Unix_shell) layer is a
  [_command-line interface_ (CLI)](https://en.wikipedia.org/wiki/Command-line_interface)
...
* At this point, you may ask yourself why do we want to work with a Unix
  command-line interface in a terminal window.  
  &nbsp;&nbsp;
* The answer is because the command-line interface allows you to use computing in a
...
* In summary, the command-line interface facilitates the release of your full
  potential as a computational biologist..
